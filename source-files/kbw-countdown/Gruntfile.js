...
module.exports = function (grunt) {
    ...
    grunt.registerTask("dist", ["copy:dist", "replace:dist", "zip"]);

    grunt.registerTask("test", ["replace:testmin", "qunit", "clean:tests"]);

    grunt.registerTask("default", ["clean:build", "jshint", "uglify", "test", "jsdoc", "dist"]);
};
